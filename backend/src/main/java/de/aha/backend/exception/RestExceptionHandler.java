...
import static de.aha.backend.exception.ExceptionHelper.getJsonExceptionMessage;
import static de.aha.backend.exception.ExceptionHelper.getRootCauseMessage;
